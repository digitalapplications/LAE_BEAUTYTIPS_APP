...
public class beautyDataSource {
    ...
    public boolean createData(String image1,String image2,String image3, String title,String type,String desc1,String desc2,String desc3){
        open();
    ...
    public void deleteData(String s) {
        open();
//        String where =
        database.delete(beautyOpenHelper.TABLE_NAME,"ID = ?",new String[] {s});
//        database.delete()
        close();
